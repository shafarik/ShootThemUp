...
void USTUWeaponComponent::EndPlay(const EEndPlayReason::Type EndPlayReasom)
{
    ...
    Super::EndPlay(EndPlayReasom);
}

void USTUWeaponComponent::AttachWeaponToSocket(ASTUBaseWeapon* Weapon, USceneComponent* SceneComponent, const FName& ScoketName)
{
