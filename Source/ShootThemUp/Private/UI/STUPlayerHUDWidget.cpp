...
void USTUPlayerHUDWidget::OnHealthChanged(float Health, float HealthDealta)
{
    if (HealthDealta < 0.0f)
    {
        OnTakeDamage();
...
void USTUPlayerHUDWidget::OnNewPawn(APawn* NewPawn)
{
    ...
    if (HealthComponent)
    {
        HealthComponent->OnHealthChenged.AddUObject(this, &USTUPlayerHUDWidget::OnHealthChanged);
    }
    UpdateHealthBar();
}
